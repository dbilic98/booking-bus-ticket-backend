...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({PassengerCategoryNotFoundException.class, PlaceNotFoundException.class, ReservationNotFoundException.class, RouteNotFoundException.class, ScheduleNotFoundException.class, SeatNotFoundException.class, TicketNotFoundException.class})
